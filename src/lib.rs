...
pub use agent::{
    builder_tool_set, default_transformer_agent, find_refactor_targets, llm_payload_to_core,
    path_under_scope, scout_tool_set, transformer_tool_set, AgentContext, AgentLoopOrchestrator,
    AutonomousAgent, BuildCommandRunner, BuilderAgent, DefaultBuilderAgent,
    DefaultTransformerAgent, EvaluatorAgent, LogAnalyzerAgent, ScoutAgent, ScoutModelTurn,
    ScoutToolCall, SystemBuildRunner, TextPrunerMock, TransformerAgent, TriageAgent,
    WebFetcherAgent, BUILDER_SYSTEM_PROMPT, EVALUATOR_SYSTEM_PROMPT, LOG_ANALYZER_SYSTEM_PROMPT,
    SCOUT_SYSTEM_PROMPT, TRANSFORMER_MAX_ITERATIONS, TRANSFORMER_SYSTEM_PROMPT,
...
pub use llm::{
    ...
    create_llm_client_for_phase, create_log_analyzer_llm_client, create_scout_llm_client,
    ...
    LlmToolSet, LlmUsage, ParamType, ToolDefinition, ToolInvocationResult, ToolParam,
};
pub use mcp::{
    analyze_log_schema, evaluate_agent_performance_schema, execute_global_refactor_schema,
    generate_tests_and_scaffolding_schema, handle_analyze_log, handle_evaluate_agent_performance,
    ...
    scout_context_schema, verify_and_triage_schema, web_fetch_schema, ANALYZE_LOG_TOOL_NAME,
