...
pub use handlers::{
    ...
    handle_generate_tests_and_scaffolding, handle_plan_blueprint, handle_query_job_status,
    handle_scout_context, handle_transpile_types, handle_verify_and_triage, handle_web_fetch,
    plan_blueprint_schema, registered_mcp_tools, scout_context_schema, transpile_types_schema,
