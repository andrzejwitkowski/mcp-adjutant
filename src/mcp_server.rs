...
use crate::mcp::{
    ...
    handle_execute_global_refactor, handle_generate_tests_and_scaffolding, handle_plan_blueprint,
    ...
    BABYSIT_PR_TOOL_NAME, EVALUATE_AGENT_PERFORMANCE_TOOL_NAME, EXECUTE_GLOBAL_REFACTOR_TOOL_NAME,
    GENERATE_TESTS_AND_SCAFFOLDING_TOOL_NAME, PLAN_BLUEPRINT_TOOL_NAME, SCOUT_CONTEXT_TOOL_NAME,
...
async fn handle_tool_call(
    ...
    let result = match name {
        ...
        PLAN_BLUEPRINT_TOOL_NAME => handle_plan_blueprint(arguments, config_snapshot, &jobs).await,
